...
abstract class Base extends \App\Commands\Base
{
    ...
    {
        return [
            $this->prepareInputOption('serverName', 'Name of the server to build on'),
            $this->prepareDefaultInputOption('host', 'localhost', 'Host name of the server to build on'),
            $this->prepareInputOption('id', 'Id of build, default: [serverName]_build'),
        ];
    }
